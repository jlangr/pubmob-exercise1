...
* Install [mob](https://github.com/mobprogramming/mob), a tool for Git handover. We'll be using Zoom, so try to configure the part about automating the Zoom share.
